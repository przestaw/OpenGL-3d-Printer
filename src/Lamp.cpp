...
Lamp::Lamp(const glm::vec3 lightPosition, const Material& material) {
  ...
  BasicCone bottomCone =
      BasicCone(glm::vec3(0.7f, 0.1f, 0.2f), 0.06f, 0.1f, 0.15f, 32);
  ...
  BasicCone topCone =
      BasicCone(glm::vec3(0.7f, 0.1f, 0.2f), 0.06f, 0.15f, 0.1f, 32);
...
void Lamp::Draw(ShaderProgram shaderBasic, ShaderProgram shaderLamp,
