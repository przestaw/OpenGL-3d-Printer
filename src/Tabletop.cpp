...
Tabletop::Tabletop(GLfloat scale) {
  ...
  BasicCuboid table(glm::vec3(0.8, 0.1, 0.1), lenght * 0.85, 2 * rodR,
                    lenght * 0.85);

  table.translate(glm::vec3(0.0, 7 * rodR, 0.0));
  table.rotate(glm::vec3(1.0, 0.0, 0.0), BasicCone::PI);
  Material grill(64, Texture("res/coneTex.png"), 0.5,
                 Texture("res/coneTex.png"), 0.2);
