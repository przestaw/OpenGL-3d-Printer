...
Arm::Arm(GLfloat scale) {
  ...
  thread.rotate(glm::vec3(1.0, 0.0, 0.0), BasicCylinder::PI / 2);
  ...
  motor.rotate(glm::vec3(1.0, 0.0, 0.0), BasicCylinder::PI / 4);

  Material darkPlastic(26.0f, Texture("res/motor.jpg"), 0.9f,
                       Texture("res/white.jpg"), 0.5f);
