...
Material::Material(const GLfloat shininess) : shininess(shininess) {}

Material::Material(const Texture& texture, const GLfloat impact,
                   GLfloat shininess)
    : shininess(shininess), diffuseMap(texture), specularMap(texture),
      diffuseImpact(impact), specularImpact(impact) {}

Material::Material(const GLfloat shininess, const Texture& diffuseMap,
                   const GLfloat diffuseImpact, const Texture& specularMap,
                   const GLfloat specularImpact)
    : shininess(shininess), diffuseMap(diffuseMap),
      diffuseImpact(diffuseImpact), specularMap(specularMap),
...
Texture Material::getDiffuseMap() { return diffuseMap; }
...
Texture Material::getSpecularMap() { return specularMap; }
