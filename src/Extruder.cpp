...
Extruder::Extruder(GLfloat scale) {
  ...
  // First main blocks
  BasicCuboid handle(glm::vec3(0.01, 0.01, 0.01), rodR * 3, rodR * 18,
                     rodR * 12);
  BasicCuboid mainBlock(glm::vec3(0.01, 0.01, 0.01), rodR * 12, rodR * 16,
                        rodR * 5);
  ...
  Material extrudeMat(10, Texture("res/extrude.jpg"), 0.6,
                      Texture("res/extrude_ref.jpg"), 0.6);
  ...
  fan1.rotate(glm::vec3(1.0, 0.0, 0.0), BasicCylinder::PI / 2);
  fan2.rotate(glm::vec3(1.0, 0.0, 0.0), BasicCylinder::PI / 2);
  screwFan2.rotate(glm::vec3(1.0, 0.0, 0.0), BasicCylinder::PI / 2);
  ...
  Material neadleMat(256, Texture("res/thread_ref.jpg"), 0.3,
                     Texture("res/white.jpg"), 0.4);
