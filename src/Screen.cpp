...
const double Screen::PI = 3.14159265358979323846;
...
Screen::Screen(GLfloat scale, GLshort number = 0)
  ...
  units.rotate(glm::vec3(0.0f, 1.0f, 0.0f), -PI / 2);
  tens.rotate(glm::vec3(0.0f, 1.0f, 0.0f), -PI / 2);
  hundreds.rotate(glm::vec3(0.0f, 1.0f, 0.0f), -PI / 2);
  units.rotate(glm::vec3(1.0f, 0.0f, 0.0f), -PI / 2);
  tens.rotate(glm::vec3(1.0f, 0.0f, 0.0f), -PI / 2);
  hundreds.rotate(glm::vec3(1.0f, 0.0f, 0.0f), -PI / 2);
}
