...
Digit::Digit(GLfloat scale)
{
	...
	segments[2].rotate(glm::vec3(0.0f, 0.0f, 1.0f), BasicCylinder::M_PI/2);
	// Right top
	...
	segments[5].rotate(glm::vec3(0.0f, 0.0f, 1.0f), BasicCylinder::M_PI/2);
	// Middle
	segments[6].translate(glm::vec3(0.0f, 0.0f, lenght));
	segments[6].rotate(glm::vec3(0.0f, 0.0f, 1.0f), BasicCylinder::M_PI/2);

	//for (auto i : segments)
		//i.rotate(glm::vec3(1.0f, 0.0f, 0.0f), BasicCylinder::M_PI / 2);
}
