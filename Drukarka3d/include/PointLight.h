...
public:
	...
	enum class LightRange {
		RANGE_7,	RANGE_13,	RANGE_20,
		RANGE_32,	RANGE_50,	RANGE_65,
		RANGE_100,	RANGE_160,	RANGE_200,
	...
	// Constant, linear and Quadratic parameters are responsible for how smooth and how fast light will attenuate
	// There are methods for setting it manually, however it is prefered to use setLightRange method as it uses
	// predefined values taken from http://wiki.ogre3d.org/tiki-index.php?page=-Point+Light+Attenuation
