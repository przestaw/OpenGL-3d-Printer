...
private:
  ...
  // In order to achieve smooth transition in spotlight from light to dark two
  // cut offs are defined. First tells where light starts to darken and second
  // where light turns to dark completely. Between these two amount of light is
  // calculated based on position of fragment between those cutoffs.
  GLfloat cutOff;
  GLfloat outerCutOff;
};
